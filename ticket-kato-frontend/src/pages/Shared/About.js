...
const About = () => {
  return (
    <>
      <div className="2xl:container 2xl:mx-auto lg:py-3 lg:px-20 md:py-2 md:px-3 py-3 px-4 mt-3">
        <p className=" leading-3 text-indigo-700 hover:text-indigo-800 cursor-pointer pb-2 fs-1 font-semibold text-center mb-8">
          About
        </p>
      ...
      <section class="mt-10 p-5">
        <div class="container px-6 py-10 mx-auto">
          ...
          <div class="grid grid-cols-1 gap-8 mt-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-3  border-gray-700">
            <div class="flex flex-col items-center p-8 transition-colors duration-300 transform cursor-pointer group hover:bg-blue-600 rounded-xl border-gray-700 border-1 shadow-lg">
              ...
              <p class="mt-2 text-gray-500 capitalize ">Team Lead</p>
            ...
            <div class="flex flex-col items-center p-8 transition-colors duration-300 transform cursor-pointer group hover:bg-blue-600 rounded-xl border-gray-700 border-1 shadow-lg">
              <img
                class="object-cover w-32 h-32 rounded-full ring-4 ring-gray-300"
                src="https://media.licdn.com/dms/image/C5603AQErwn6ebPXfPA/profile-displayphoto-shrink_800_800/0/1649586842746?e=1681948800&v=beta&t=Au3m5vijBrZmavFgfyEuNi122Xl04PXYn3a-6x8BEHI"
                alt=""
              />
              ...
              <p class="mt-2 text-gray-500 capitalize ">Backend Developer</p>
            ...
            <div class="flex flex-col items-center p-8 transition-colors duration-300 transform cursor-pointer group hover:bg-blue-600 rounded-xl border-gray-700 border-1 shadow-lg">
              <img
                class="object-cover w-32 h-32 rounded-full ring-4 ring-gray-300"
                src="https://media-exp1.licdn.com/dms/image/C4E03AQHSzzcebLeAdA/profile-displayphoto-shrink_800_800/0/1654626725949?e=1667433600&v=beta&t=UkrMjGHgVNfbNyYNzTfDNgDFLk2hOyCgcWq2Q3hzhTE"
                alt=""
              />
              ...
              <p class="mt-2 text-gray-500 capitalize ">UI/UX Developer</p>
            ...
            <div class="flex flex-col items-center p-8 transition-colors duration-300 transform cursor-pointer group hover:bg-blue-600 rounded-xl border-gray-700 border-1 shadow-lg">
              <img
                class="object-cover w-32 h-32 rounded-full ring-4 ring-gray-300"
                src="https://scontent.fdac11-2.fna.fbcdn.net/v/t1.6435-9/124647427_1537355706475489_6382127376298263845_n.jpg?_nc_cat=100&ccb=1-7&_nc_sid=174925&_nc_eui2=AeFf2vsnKticKDB8pD6-3IiLmPW-xRmVpGWY9b7FGZWkZbuSRUffvtuvnivT1fpOZF_j96pONivo-OfK_12Ic72K&_nc_ohc=Ej_ccjYAPGMAX_0sxrm&tn=nzgR1Grm4EITYMrm&_nc_ht=scontent.fdac11-2.fna&oh=00_AT-XwbjxJz5k252aUL125gEuzKyS6Elt4qunnYF3PmjzBw&oe=63334050"
                alt=""
              />
              ...
              <p class="mt-2 text-gray-500 capitalize ">Frontend Developer</p>
            ...
            <div class="flex flex-col items-center p-8 transition-colors duration-300 transform cursor-pointer group hover:bg-blue-600 rounded-xl border-gray-700 border-1 shadow-lg w-full mx-auto lg:ml-52">
              ...
              <p class="mt-2 text-gray-500 capitalize ">Frontend Designer</p>
            ...
            <div class="flex flex-col items-center p-8 transition-colors duration-300 transform cursor-pointer group hover:bg-blue-600 rounded-xl border-gray-700 border-1 shadow-lg">
              <img
                class="object-cover w-32 h-32 rounded-full ring-4 ring-gray-300"
                src="https://media-exp1.licdn.com/dms/image/C4D03AQELJeYGLmGo2w/profile-displayphoto-shrink_800_800/0/1654695002113?e=1667433600&v=beta&t=JZCdVPqhC3Hr9s-4qB1g8eU0vP_fjQ8An_V76F1zv-Q"
                alt=""
              />
